...
def main():
    ap=argparse.ArgumentParser(description="Recalibrate payouts and set PAUSE_EXOTIQUES flag")
    ap.add_argument("--history", nargs="+", required=True, help="Fichiers JSON de rapports")
    ap.add_argument("--out", default="payout_calibration.yaml")
    args=ap.parse_args()
