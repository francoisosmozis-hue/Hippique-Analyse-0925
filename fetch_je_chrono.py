...
try:
    ...
    print("ERROR: Could not import enrich_from_snapshot. Make sure scripts/snapshot_enricher.py exists.", file=sys.stderr)
    sys.exit(1)
...
def main():
    """CLI entry point."""
    parser = argparse.ArgumentParser(description="Generate chronos.csv and je_stats.csv from a snapshot.")
