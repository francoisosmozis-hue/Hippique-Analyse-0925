...
def has_argparse(p: Path) -> bool:
    try:
        ...
        return False
    return (
        "argparse.ArgumentParser(" in txt
        or "from argparse import ArgumentParser" in txt
    )
...
try:
    ...
    sys.exit(int(getattr(e,'code',1) or 0))
except Exception as e:
...
def main():
    ...
    for p in iter_py_files(root):
        ...
        if args.mode == "helpcheck":
            ...
            if rc not in (0,):  # on veut que --help sorte proprement
