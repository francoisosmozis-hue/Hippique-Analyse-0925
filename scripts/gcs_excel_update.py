...
def main():
    ...
    with tempfile.TemporaryDirectory() as td:
        ...
        row = [
            args.date, args.reunion, args.course, args.hippodrome, args.discipline,
            args.phase, args.jouable, args.tickets, args.mises, args.gains,
            args.__dict__["roi_estime"], args.__dict__["roi_reel"], args.notes
        ]
