#!/bin/bash
# scripts/deploy.sh - Deploy Hippique Analyse to Cloud Run
...
QUEUE_ID="${QUEUE_ID:-hippique-analyse-tasks}"
...
echo "================================================"
echo "  Hippique Analyse - Cloud Run Deployment"
echo "================================================"
echo ""
...
if ! gcloud iam service-accounts describe "$SERVICE_ACCOUNT_EMAIL" \
    ...
    gcloud iam service-accounts create "${SERVICE_NAME}" \
        --display-name="Hippique Analyse Service Account" \
        --project="$PROJECT_ID"
...
echo ""
echo "2. Create Cloud Scheduler jobs as needed."
echo ""
echo "3. Monitor logs:"
