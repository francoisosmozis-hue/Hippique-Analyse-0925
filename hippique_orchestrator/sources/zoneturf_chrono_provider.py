# hippique_orchestrator/sources/zoneturf_chrono_provider.py
...
class ZoneTurfChronoProvider(BaseProvider):
    """
    Provider for Zone-Turf chrono data.
    NOTE: This is a stub and does not contain a real implementation for program/runner fetching.
    It was originally designed to fetch specific chrono stats.
    """

    @property
    def name(self) -> str:
        return "zoneturfchrono"
