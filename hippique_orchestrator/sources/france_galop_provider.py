# hippique_orchestrator/sources/france_galop_provider.py
...
class FranceGalopProvider(BaseProvider):
    """
    Provider for France-Galop.com data.
    NOTE: This is a stub and does not contain a real implementation.
    """
