...
def test_apply_summary_to_ticket_container():
    ...
    container = {}
    summary = PostCourseSummary(total_gain=50, total_stake=25, roi=1.0, ev_total=5, ev_diff_total=45,
                                result_mean=0.5, roi_ticket_mean=0.8, brier_total=0.7, brier_mean=0.35)
...
def test_build_payload():
    ...
    meta = {"rc": "R1C1"}
    tickets = [{"id": "1"}]
    summary = PostCourseSummary(total_gain=10, total_stake=5, roi=1.0, ev_total=1, ev_diff_total=9,
                                result_mean=1, roi_ticket_mean=1, brier_total=0, brier_mean=0)
...
def test_build_payload_from_sources():
    ...
    tickets_container = {"meta": {"rc": "R1C1"}, "tickets": [{"id": "3", "stake": 10, "gain_reel": 50}]}
...
def test_format_csv_line():
    ...
    summary = PostCourseSummary(total_gain=10, total_stake=5, roi=1.0, ev_total=1, ev_diff_total=9,
                                result_mean=1, roi_ticket_mean=1, brier_total=0.1, brier_mean=0.05)
