...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape horse racing odds from Geny.com.")
    parser.add_argument("--course-id", required=True, help="The ID of the race on Geny.com.")
